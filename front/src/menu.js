class Menu {
  constructor({ menu, gameCanvas, gameMenu, gameContext, document }) {
    ...
    this.document
      .getElementById("menu__action__single-game")
      .addEventListener("click", () => {
        this.setUpSinglePlayerGame();
      });

    this.document
      .getElementById("game__menu__action__resume")
      .addEventListener("click", () => {
        this.onGamePause();
      });

    this.document
      .getElementById("game__menu__action__quit")
      .addEventListener("click", () => {
    ...
    this.document
      .getElementById("game__menu__action__restart")
      .addEventListener("click", () => {
        this.game.restart();
        this.gameMenu.style.display = "none";
        this.gameMenuOpen = false;
